# TODO: This class needs to be refactored to match current standard as well as renamed to avoid
...
from ..gcp.datastore_manager import DataStoreManager
...
from ..globals import DatastoreKeyTypes, PubSub, BuildConstants
            ...
            if build_type == str(BuildConstants.BuildType.FIXED_ARENA_CLASS.value):
                if self._check_agency_topics():
                    ...
                    for workspace in workspaces:
                        ...
                        if not self.debug:
                            PubSubManager(topic=str(PubSub.Topics.AGOGE), env_dict=self.env_dict).msg(
